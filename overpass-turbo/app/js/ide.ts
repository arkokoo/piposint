...
import piposintSettings from "./piposint";

declare const CodeMirror;

if (piposintSettings.history == false) {
...
class IDE {
  ...
  onRunClick() {
    if (piposintSettings.history == true) {
  ...
  onEnableHistoryClick() {
    if (piposintSettings.history == false) {
        piposintSettings.setHistory(true);
        $("#history-button").removeClass("disabled");

    } else {
        piposintSettings.setHistory(false);
        $("#history-button").addClass("disabled");
    }
  }
